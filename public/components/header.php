    ...
    <nav class="mx-auto px-6 py-4 lg:py-0">
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:flex items-center space-x-8">
                <!-- Главная -->
                <a href="/" class="py-6 text-gray-600 hover:text-blue-600 transition">Главная</a>
                <!-- Услуги -->
                <div class="drop py-6">
                    <a href="/">
                        Услуги
                        <i class="fas fa-chevron-down dropdown-arrow arrow"></i>
                    </a>
                    <ul class="flex p-4 py-0">
                        ...
                        <div class="flex flex-col">
                            <span class="drop-title">Виды ремонта</span>
    ...
    <div class="p-6">
        <div class="flex justify-between items-center mb-8">
            <div class="flex items-center space-x-2">
                <!-- logo name -->
                <a href="/" class="flex items-center space-x-2">
                    <img class="h-12" src="/public/assets/images/logo/full.svg" alt="">
                </a>
            </div>
